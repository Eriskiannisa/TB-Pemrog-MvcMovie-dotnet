...
namespace MvcMovie.Controllers
{
    public class TheatersController : Controller
    {
        ...
        public TheatersController(MvcMovieContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,City")] Theater theater)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,City")] Theater theater)
        {
            if (id != theater.Id)
            {
                return NotFound();
